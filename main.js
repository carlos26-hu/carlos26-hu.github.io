...
function calcMin() {
    ...
    document.querySelector("span#tempMin").innerHTML = minTemp + " &degC";
}
...
function calcMax() {
    ...
    document.querySelector("span#tempMax").innerHTML = maxTemp + " &degC";
}
...
function calcAvg() {
    ...
    avgTemp = avgTemp / 7;
    document.querySelector("span#tempAvg").innerHTML = avgTemp.toFixed(2) + " &degC";
}